      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div>
              <h2
                className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter mb-6"
              >
                <span className="text-white">WANT TO </span>
                <span className="text-brand-primary">LEARN</span>
                <span className="text-white"> MORE?</span>
              </h2>
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-brand-primary mb-8">{content.join.membersCount}</div>
            </div>
            ...
            <div className="space-y-4">
              <motion.div
                ...
                className="flex items-center gap-3 text-brand-accent text-base sm:text-lg"
              >
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <p className="text-base sm:text-lg text-brand-accent leading-relaxed">
